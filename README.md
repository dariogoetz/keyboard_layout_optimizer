...
- **similar letter-groups** - Which groups of keys are similar (in some sense), but lie in non-consistent locations (e.g. "aou" - "äüö")? Used to be called "asymmetric keys".
